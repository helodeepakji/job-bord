    ...
    public function setup(): void
    {
        ...
        $this
            ...
            ->add(
                ...
                OnOffCheckboxField::class,
                OnOffFieldOption::make()
                    ->value(JobBoardHelper::isSalaryHiddenForGuests())
            ...
            ->add(
                ...
                OnOffCheckboxField::class,
                OnOffFieldOption::make()
                    ->value(JobBoardHelper::isCompanyInformationHiddenForGuests())
            ...
            ->add(
                ...
                OnOffCheckboxField::class,
                OnOffFieldOption::make()
                    ->value(JobBoardHelper::isCandidateInformationHiddenForGuests())
            ...
            ->add(
                ...
                OnOffCheckboxField::class,
                OnOffFieldOption::make()
                    ->collapsible('job_board_hide_candidate_information_for_guests', 1, JobBoardHelper::isCandidateInformationHiddenForGuests())
                    ->value(JobBoardHelper::isOnlyEmployerCanViewCandidateInformation())
